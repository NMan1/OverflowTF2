...
public:
	...
	virtual bool send_net_msg(INetMessage& msg, bool bForceReliable = false, bool bVoice = false) = 0;
#ifdef POSIX
	FORCEINLINE bool send_net_msg(INetMessage const& msg, bool bForceReliable = false, bool bVoice = false)
	{
		return send_net_msg(*((INetMessage*)&msg), bForceReliable, bVoice);
	}
#endif
...
public:
	...
	virtual bool ReadFromBuffer(unsigned int& buffer) = 0; // returns true if parsing was OK
	virtual bool WriteToBuffer(unsigned int& buffer) = 0; // returns true if writing was OK
